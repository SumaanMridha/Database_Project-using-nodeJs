...
async function addreport(post_id, user_id, body){
    const sql = `INSERT INTO REPORTS(REPORT_ID, USER_ID, POST_ID, BODY)
                    VALUES(REPORT_SEQ.nextval, :user_id, :post_id, :body)`;
...
async function updatereport(report_id, body){
